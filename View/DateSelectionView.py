...
class DateSelectorView():
    ...
    def __init__(self, master):
        ...
        self.__window.__cal = DateEntry(
            self.__window, selectmode='day', background='darkblue', foreground='white', borderwidth=2)
        ...
        self.__window.__lbl = tk.Label(
            self.__window, text=":", width=1).grid(row=0, column=2)
        self.__window.__entryMinuta = tk.Entry(self.__window, width=2)
        self.__window.__entryMinuta.grid(row=0, column=3)
        self.__window.__lbl2 = tk.Label(
            self.__window, text=":", width=0).grid(row=0, column=4)
